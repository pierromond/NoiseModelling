 ...
 */
public class BR_PtGrid_f extends AbstractFunction implements ScalarFunction {
    ...
    public static ResultSet noisePropagation(Connection connection, String buildings,
        ...
        return BR_PtGrid3D_f.noisePropagation(connection, buildings, "", sources, receivers_table, sound_lvl_field,
