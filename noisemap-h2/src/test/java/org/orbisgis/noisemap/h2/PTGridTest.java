...
public class PTGridTest {
    ...
    public static void tearUpClass() throws Exception {
        ...
        CreateSpatialExtension.registerFunction(connection.createStatement(), new BR_PtGrid_f(), "");
        CreateSpatialExtension.registerFunction(connection.createStatement(), new BR_PtGrid3D_f(), "");
        CreateSpatialExtension.registerFunction(connection.createStatement(), new BR_PtGrid_Att_f(), "");
        CreateSpatialExtension.registerFunction(connection.createStatement(), new BR_PtGrid3D_Att_f(), "");
