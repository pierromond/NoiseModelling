        ...
        public void run() {
            for (int idReceiver = startReceiver; idReceiver < endReceiver; idReceiver++) {
                ...
                for (energeticSource source : energeticId) {
                    ...
                    allfreqs[0] = Math.max(-100,wToDba((source.freqs[0]+source.freqs[1]+source.freqs[2]+source.freqs[3]+source.freqs[4]+source.freqs[5]+source.freqs[6]+source.freqs[7]))-wToDba(8.*reference));
                    allfreqs[1] = Math.max(-100,wToDba(source.freqs[0])-wToDba(reference));
                    allfreqs[2] = Math.max( -100,wToDba(source.freqs[1])-wToDba(reference));
                    allfreqs[3] = Math.max(-100,wToDba(source.freqs[2])-wToDba(reference));
                    allfreqs[4] = Math.max(-100,wToDba(source.freqs[3])-wToDba(reference));
                    allfreqs[5] = Math.max(-100,wToDba(source.freqs[4])-wToDba(reference));
                    allfreqs[6] = Math.max(-100,wToDba(source.freqs[5])-wToDba(reference));
                    allfreqs[7] = Math.max(-100,wToDba(source.freqs[6])-wToDba(reference));
                    allfreqs[8] = Math.max(-100,wToDba(source.freqs[7])-wToDba(reference));
                   // allfreqs[0] = source.freqs[0]+source.freqs[1]+source.freqs[2]+source.freqs[3]+source.freqs[4]+source.freqs[5]+source.freqs[6]+source.freqs[7];
                   // allfreqs[1] = source.freqs[0];
                   // allfreqs[2] = source.freqs[1];
                   // allfreqs[3] = source.freqs[2];
                   // allfreqs[4] = source.freqs[3];
                   // allfreqs[5] = source.freqs[4];
                   // allfreqs[6] = source.freqs[5];
                   // allfreqs[7] = source.freqs[6];
                   // allfreqs[8] = source.freqs[7];
