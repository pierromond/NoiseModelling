...
class DroneThirdProcessData {
    ...
    double[] getDroneLevel(int idSphere, double theta, double phi) throws SQLException {
        ...
        res_d = readDroneFile("E:\\Projets\\2019_2020 DRONE\\PACKAGE for SIMULATIONS_2\\NOISE_SOURCE\\idNoiseSphere_" + idSphere + ".txt", thetathird, phithird)
...
class DroneThirdPropagationProcessData extends PropagationProcessData {
    ...
    public void addSource(Long pk, Geometry geom, SpatialResultSet rs) throws SQLException {
        ...
        double[] res_d = new double[propagationProcessPathData.getFreq_lvl().size()]

        res_d = [db_m50,db_m63,db_m80,db_m100,db_m125,db_m160, db_m200,db_m250, db_m315,
                db_m400 ,db_m500,db_m630 , db_m800 ,db_m1000, db_m1250,db_m1600,
                 db_m2000,
                 db_m2500,
                 db_m3150,
                 db_m4000,
...
def run(input) {
    ...
    openGeoserverDataStoreConnection(dbName).withCloseable { Connection connection ->
        ...
        //def  freq_lvl = [50,63,80,100, 125,160, 200,250,315,400 ,500,630,800, 1000,1250,1600, 2000,2500,3150, 4000,5000,6300, 8000,10000]
        //def freq_lvl_exact = [50.0, 63.0,80.0,100.0, 125.8,160.0,200.0 ,251.18,315.0,400.0, 501.1,630.0,800.0, 1000.0,1250.0,1600.0, 1995.2,2500.0,3150.0, 3981.0,5000.0,6300.0 ,7943.2,10000.0]


        propagationProcessPathData.setFreq_lvl(freq_lvl)
        propagationProcessPathData.setFreq_lvl_exact(freq_lvl_exact)
        ...
        for (int t = 1; t <= 100; t++) {
            ...
            sql.eachRow('SELECT PK, PK_POSITION, PHI, T, idSource, idNoiseSphere FROM ' + sources_time_table_name + '_with_pkPosition WHERE T = ' + t.toString() + ';') { row ->
